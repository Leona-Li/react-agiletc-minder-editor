...
class Runtime {
    ...
    constructor(props) {
            ...
            window.minder.on('contextmenu', e => {
                if (window.minder.getStatus() === 'normal') {
                    if (editorCommand.isNode()) {
                        const position = window.minder.getSelectedNode().getRenderBox('TextRenderer');
        ...
        // 监听快捷键
        document.getElementById('kityminder-core').addEventListener('keydown', this.handleListenerForEditor, false);
        ...
        // 监听输入框的键盘事件
        document.getElementById('core-node-input-disableKeydown').addEventListener('keydown', this.handleListenerForInput, false);
    ...
    handleListenerForInput = (e) => {
        ...
        if (!e.altKey && e.keyCode === 13) { // Enter 保存并退出
            e.stopPropagation();
            e.preventDefault();
            this.saveAndExit();
            return;
        ...
        if (e.altKey && e.keyCode === 13) { // Alt + Enter 换行
            e.stopPropagation();
            e.preventDefault();
            const value = $('#core-node-input-disableKeydown').val();
            let posReal = document.getElementById('core-node-input-disableKeydown')['selectionStart'];
            let pos = posReal //? posReal : String(value).length - 1;
            const newValue = String(value).substr(0, pos) + '\r\n' + String(value).substr(pos, String(value).length);
            this.props.handleChange(newValue);
            document.getElementById('core-node-input-disableKeydown')['setSelectionRange'] && document.getElementById('core-node-input-disableKeydown')['setSelectionRange'](pos + 1, pos + 1);
            return;
        }
    ...
    handleListenerForEditor = (e) => {
        ...
        if (!this.props.state.readOnly) {
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 49) { // 前置条件  ctrl + 1
                this.addTag("前置条件");
                e.stopPropagation();
                e.preventDefault();
                return;
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 50) { // 操作步骤  ctrl + 2
                this.addTag("执行步骤");
                e.stopPropagation();
                e.preventDefault();
                return;
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 51) { // 预期结果 ctrl + 3
                this.addTag("预期结果");
                e.stopPropagation();
                e.preventDefault();
                return;
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 75) { // Ctrl + K 调出链接的添加菜单
            ...
            if (e.altKey && e.keyCode === 38) { // 节点上移alt + Up
                editorCommand.handleUp();
                e.stopPropagation();
                e.preventDefault();
                return;
            }
            if (e.altKey && e.keyCode === 40) { // 节点下移alt + Down
            ...
            if (e.keyCode === 8 || e.keyCode === 46) { // 删除Delete
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 88) { // 撤销Ctrl + X
        ...
        if (this.props.props.type === 'record') {
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 48) { // 清除执行结果  ctrl + 0
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 49) { //执行通过   ctrl + 1
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 50) { //执行失败 ctrl + 2
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 51) { //阻塞  ctrl+3
            ...
            if ((e.ctrlKey || e.metaKey) && e.keyCode === 52) { // 不适用 预期结果 ctrl + 4
        ...
        if (e.ctrlKey && e.keyCode === 65) { // 全选Ctrl + a
            let selectedNodes = [];
        ...
        if ((e.ctrlKey || e.metaKey) && e.keyCode === 90) { // 撤销Ctrl + z
        ...
        if ((e.ctrlKey || e.metaKey) && e.keyCode === 187) { // 缩小
        ...
        if ((e.ctrlKey || e.metaKey) && e.keyCode === 189) { // 放大
        ...
        if ((e.ctrlKey || e.metaKey) && e.keyCode === 89) { // 重做Ctrl + y
        ...
        if ((e.ctrlKey || e.metaKey) && e.shiftKey && e.keyCode === 76) { // Ctrl +shift + L
