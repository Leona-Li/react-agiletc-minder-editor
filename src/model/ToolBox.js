...
class ToolBox {
    ...
    constructor(props) {
        ...
        // 退出备注预览
        $('#kityminder-core').on('mousedown mousewheel DOMMouseScroll', this.exitNotePreview);
    ...
    preview = (node) => {
        let icon = node.getRenderer('NoteIconRenderer').getRenderShape().getRenderBox('screen');
        ...
        let x = icon.left - (document.documentElement.clientWidth - editors[0].clientWidth);
